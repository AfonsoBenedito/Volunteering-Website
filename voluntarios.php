...
<body>
    ...
    <div class="apresentacaoVolInst">
        ...
        <?php
                ...
                $comando = "SELECT Username, Nome, Apelido, Nascimento, Distrito, ImagePath FROM voluntariosVC19;";
                ...
                while ($row = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) {
                    ...
                    $today = new DateTime();
                    $birthdate = new DateTime($row['Nascimento']);
